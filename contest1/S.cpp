 ...
 */
unsigned long long count_valid_profiles(std::vector<std::vector<unsigned long long>>& cnt_profiles, unsigned long long length, unsigned long long num_of_masks) {
 ...
 */
void generate_similarity_table(std::vector<std::vector<bool>>& bool_table, unsigned long long num_of_masks, unsigned long long width) {
    for (unsigned long long i = 0; i < num_of_masks; i++) {
 ...
 */
void count_profiles(const std::vector<std::vector<bool>>& bool_table, std::vector<std::vector<unsigned long long>>& cnt_profiles, unsigned long long length, unsigned long long num_of_masks) {
...
int main() {
    ...
    std::vector<std::vector<unsigned long long>> cnt_profiles(length, std::vector<unsigned long long>(num_of_masks));
    for (unsigned long long i = 0; i < num_of_masks; ++i) {
        cnt_profiles[0][i] = 1;
    }
    count_profiles(bool_table, cnt_profiles, length, num_of_masks);
    std::cout << count_valid_profiles(cnt_profiles, length, num_of_masks);
}